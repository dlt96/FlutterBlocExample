...
class _DetailPageState extends State<DetailPage> {
  ...
  void initState() {
    super.initState();
    _detailBloc.onShowDetail(
        id: widget
            .videoId); //we call widget.videoId instead of super.videoId bcs its a wid
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      bloc: _detailBloc,
      child: Scaffold(
        body: BlocBuilder(bloc: _detailBloc, builder: _buildScaffoldContent),
      ),
    );
  }
